...
\twocolumn[%
  \begin{@twocolumnfalse}
    \maketitle
    \begin{center}\small All pipeline available on
      \texttt{github.com/sussolinoss/sports-ml-predictions}\end{center}
...
My model, reproducible run & \textbf{0.778} \\
My model, best seed on validation & 0.833 \\
\bottomrule
\end{tabular}

\smallskip
\noindent\footnotesize Reproducible run: AUC 0.94, Brier 0.061, NDCG@3 0.826.
\end{table}
...
\begin{tabular}{@{}lcc@{}}
\toprule
Removed group & precision@3 & $\Delta$ (pt) \\
\midrule
grid + quali      & 0.639 & $-13.9$ \\
